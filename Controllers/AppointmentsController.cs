...
namespace SD1_sk072215_MIS4200.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "appointmentID,description,appointmentDate,patientId")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "appointmentID,description,appointmentDate,patientId")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
